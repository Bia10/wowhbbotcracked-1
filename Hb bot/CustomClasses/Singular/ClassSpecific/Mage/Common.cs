...
// $HeadURL: http://svn.apocdev.com/singular/tags/v1/Singular/ClassSpecific/Mage/Common.cs $
    ...
    partial class SingularRoutine
    {
        ...
        public Composite CreateMageBuffs()
        {
            return new PrioritySelector(
                ...
                new Decorator(
                    ret => TalentManager.CurrentSpec == TalentSpec.FrostMage && !Me.GotAlivePet && SpellManager.CanCast("Summon Water Elemental"),
