...
namespace Styx.Bot.Quest_Behaviors.Escort
{
    ...
    public class Escort : CustomForcedBehavior
    {
        ...
        public override string      SubversionId { get { return ("$Id: Escort.cs 201 2011-07-26 22:54:46Z chinajade $"); } }
        public override string      SubversionRevision { get { return ("$Revision: 201 $"); } }
