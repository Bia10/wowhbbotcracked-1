...
namespace Styx.Bot.Quest_Behaviors.MountHyjal
{
    public class BearsUpThere : CustomForcedBehavior
    {
        ...
        public override string      SubversionId { get { return ("$Id: BearsUpThere.cs 197 2011-07-07 03:26:35Z natfoth $"); } }
        public override string      SubversionRevision { get { return ("$Revision: 197 $"); } }
